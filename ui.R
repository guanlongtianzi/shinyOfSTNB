shinyUI(bootstrapPage(fluidPage(
  titlePanel("Self-Training Based on NaiveBayes"),
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      wellPanel(
        div(align="center",checkboxInput("naivebayes_param","Show naivebayes parameters",FALSE)),
        conditionalPanel(condition = "input.naivebayes_param==true",
    ...
    mainPanel(
      tabsetPanel(id = "tabs",
                  ...
                  tabPanel("About",
                           ...
                           aceEditor("myEditor1", value = '#R Scripts \nrequire(shiny)\nrequire(DMwR)\nrequire(ggplot2)\nrequire(shinyAce)\nrequire(gridExtra)\nrequire(rmarkdown)\nrequire(e1071)', mode="r",height = '200px',fontSize = 15,theme="ambiance"),
